...
<form action="/Registration/ServletDeleteEntry" method="post">
<br><br><br><br><br><br>

<center>
<table border=2 height="45%" bordercolor="blue" bgcolor="pink">
<tr><td>Form No:
<td><input type="text" name="form_no">
<tr><td><input type="reset" value="Reset" ><td><input type="submit" value="Delete This Entry" >
</table>
</form>
