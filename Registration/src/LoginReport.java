...
/**
 * Servlet implementation class for Servlet: LoginReport
 *
 */
 public class LoginReport extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		try
		{
			...
			try
			{
				...
				kout.println("<tr bgcolor='pink'><td>Sr No<td>User Name<td>Designation<td>Priority<td>Locked");
				int total=0;
				while(rs.next())
				{
					total=total+1;
