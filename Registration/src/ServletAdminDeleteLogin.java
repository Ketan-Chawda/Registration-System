...
/**
 * Servlet implementation class for Servlet: ServletAdminDeleteLogin
 *
 */
 public class ServletAdminDeleteLogin extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
   static final long serialVersionUID = 1L;
   
    /* (non-Java-doc)
	 * @see javax.servlet.http.HttpServlet#HttpServlet()
	 */
	public ServletAdminDeleteLogin() {
		super();
	}   	
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		try
		{
			...
			try
			{
				...
				{
					String query1;
					query1="delete * from login where userid='"+tuserid+"'";
					st=kac.createStatement();
					st.executeUpdate(query1);
					st.close();
					kout.println("<br><br><h2><center>Ok Login Deleted");
				}
				else
