...
/**
 * Servlet implementation class for Servlet: UnLockEasy
 *
 */
 public class UnLockEasy extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
   static final long serialVersionUID = 1L;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		kout.println("<html><head><title>UnLock Easily</title></head>");
		...
		try
		{
			...
			try
			{
				...
				ResultSet rs=st.executeQuery("select * from login where locked='yes'");
				
				kout.println("<br><br><br><br><br><br><br>");
				kout.println("<form action='/Registration/UnLockHelp'>");
				...
				kout.println("<tr bgcolor='pink'><td><input type='submit' value='UnLock'><td>Sr No<td>User Name<td>Designation<td>Priority<td>Locked");
				int total=0;
				while(rs.next())
				{
					total=total+1;
