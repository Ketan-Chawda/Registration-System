...
/**
 * Servlet implementation class for Servlet: ServletAdminLockLogin
 *
 */
 public class ServletAdminLockLogin extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
   static final long serialVersionUID = 1L;
   
    /* (non-Java-doc)
	 * @see javax.servlet.http.HttpServlet#HttpServlet()
	 */
	public ServletAdminLockLogin() {
		super();
	}   	
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		try
		{
			...
			try
			{
				...
				if(count!=0)
				{
					query1="update login set locked='yes' where userid='"+tuserid+"'";
					st=kac.createStatement();
					st.executeUpdate(query1);
					st.close();
					kout.println("<br><br><h2><center>Ok Login Locked Successfully");
					}
				else
