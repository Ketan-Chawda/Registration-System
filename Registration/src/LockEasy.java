...
/**
 * Servlet implementation class for Servlet: LockEasy
 *
 */
 public class LockEasy extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
   static final long serialVersionUID = 1L;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		kout.println("<html><head><title>Lock Easily</title></head>");
		...
		try
		{
			...
			try
			{
				...
				ResultSet rs=st.executeQuery("select * from login where locked='no'");
				
				kout.println("<br><br><br><br><br><br><br>");
				kout.println("<form action='/Registration/LockHelp'>");
				...
				kout.println("<tr bgcolor='pink'><td><input type='submit' value='Lock'><td>Sr No<td>User Name<td>Designation<td>Priority<td>Locked");
				int total=0;
				while(rs.next())
				{
					total=total+1;
