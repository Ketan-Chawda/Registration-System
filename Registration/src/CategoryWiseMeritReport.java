...
/**
 * Servlet implementation class for Servlet: CategoryWiseMeritReport
 *
 */
 public class CategoryWiseMeritReport extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
   static final long serialVersionUID = 1L;
   
    /* (non-Java-doc)
	 * @see javax.servlet.http.HttpServlet#HttpServlet()
	 */
	public CategoryWiseMeritReport() {
		super();
	}   	
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		kout.println("<html><head><title>CategoryWise Merit Report</title></head>");
		...
		try
		{
			...
			try
			{
				...
				ResultSet rs1=st.executeQuery("select distinct Category from meritlist");
				while(rs1.next())
				{
				mycat=rs1.getString("Category");
				
				kout.println("<br><h2>Category : "+mycat+"<br></h2>");
				...
				kout.println("<td>HSC Per<td>Stream<td>SSC Per");
				...
				ResultSet rs=st1.executeQuery("select * from meritlist where Category='"+mycat+"' order by Merit_No");
				...
				while(rs.next())
				{
					...
					//kout.println("<td>"+tcategory);//not needed now
