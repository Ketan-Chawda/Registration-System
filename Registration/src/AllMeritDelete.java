...
/**
 * Servlet implementation class for Servlet: AllMeritDelete
 *
 */
 public class AllMeritDelete extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
   static final long serialVersionUID = 1L;
   
    /* (non-Java-doc)
	 * @see javax.servlet.http.HttpServlet#HttpServlet()
	 */
	public AllMeritDelete() {
		super();
	}   	
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		try
		{
			...
			try
			{
				...
				kout.println("<form action='/Registration/AllMeritDeleteHelp'>");
				...
				kout.println("<tr bgcolor='pink'><td><input type='submit' value='Delete'><td>Merit No.<td>Form No.<td>Student Name");
