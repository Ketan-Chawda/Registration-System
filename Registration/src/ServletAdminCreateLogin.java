...
/**
 * Servlet implementation class for Servlet: ServletAdminCreateLogin
 *
 */
 public class ServletAdminCreateLogin extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
   static final long serialVersionUID = 1L;
   
    /* (non-Java-doc)
	 * @see javax.servlet.http.HttpServlet#HttpServlet()
	 */
	public ServletAdminCreateLogin() {
		super();
	}   	
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		kout.println("<html><head><title>Login Creation In Progress</title></head>");
		...
		Connection kac=null;
		Statement st;
		String tpassword="",tdesg="",tprior="",query1="",tuserid="";
		...
		try
		{
			...
			try
			{
				...
				if(count==0)
				{
					//String tpassword="",tdesg="",tprior="",query1="";
					
					tpassword=request.getParameter("password");
					tdesg=request.getParameter("desg");
					tprior=request.getParameter("prior");

					query1="insert into login(userid,password,desg,priority,locked) values('"+tuserid+"','"+tpassword+"','"+tdesg+"','"+tprior+"','no')";
					st=kac.createStatement();
					st.executeUpdate(query1);
					st.close();
					kout.println("<br><br><h2><center>Ok Login Created");
					}
				else
				kout.println("<br><br><h2><center>Sorry This User Already Exists");
